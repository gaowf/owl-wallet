...
import com.turing.wallet.model.v2.base.AbstractExample;
 ...
 * @author Mac
 */
public class ConfigLanguageExample extends AbstractExample {
    /**
     * config_language
     */
    ...
    public static class Criteria extends GeneratedCriteria {
        private ConfigLanguageExample example;

        protected Criteria(ConfigLanguageExample example) {
            super();
            this.example = example;
        }

        public ConfigLanguageExample example() {
            return this.example;
        }
    }
